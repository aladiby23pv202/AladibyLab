...
public class BankAtmServiceImpl implements BankAtmService {
    ...
    public BankAtm createBankAtm(BankAtm bankAtm) {
        BankAtm newBankAtm = new BankAtm(bankAtm.getId(), bankAtm.getName(), bankAtm.getAddress(), bankAtm.getStatus(),
                bankAtm.getBank(), bankAtm.getBankOffice(), bankAtm.getEmployee(), bankAtm.getCanIssueMoney(),
                bankAtm.getCanDepositMoney(), bankAtm.getTotalMoney(), bankAtm.getMaintenance());
        return newBankAtm;
    }
