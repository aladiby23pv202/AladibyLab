...
public class BankAtm {
    ...
    //конструктор
    public BankAtm(int id, String name, AtmStatus status, Bank bank, BankOffice bankOffice,
                   Employee employee, boolean canIssueMoney, boolean canDepositMoney, double costOfMaintenance) {
        this.id = id;
        this.name = name;
        this.status = status;
